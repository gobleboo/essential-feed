...
//  EssentialFeedTests
//
//  Created by Erick Peripolli on 13/06/23.
//
...
final class CodableFeedStoreTests: XCTestCase {
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side-effects to run serially but operations finiished in the wrong order")
    }
